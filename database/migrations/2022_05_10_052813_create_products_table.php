...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('image_1', 255)->nullable()->comment('写真1');
            $table->string('image_2', 255)->nullable()->comment('写真2');
            $table->string('image_3', 255)->nullable()->comment('写真3');
            $table->string('image_4', 255)->nullable()->comment('写真4');
